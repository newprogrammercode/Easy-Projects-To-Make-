...
class Main:
    ...
    def __init__(self):
        ...
        self.decrypt_but = Button(self.root , font = ("Comic Sans MS" , 12, "bold") , fg = "red" , borderwidth=0,bd=0 , command= lambda: self.decrypt())
        self.decrypt_but.place(relx = 0.5 , rely = 0.5)
        
        self.button = Button(self.root , text="Encrypt", font = ("Comic Sans MS" ,  12 , "bold") , fg = "red" , padx = 2 , pady = 2,borderwidth= 0 , bd = 0 , command=lambda: self.encrypt("the_key_of_the_proggram.key"))
